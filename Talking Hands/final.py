...
def main():
    ...
    while(cap.isOpened()):
        ...
        #raw_input("done!!!")
            ...
            #raw_input("done!!!")
                ...
                if previous == output:
                    ...
                    if count == 10:
                        #write text file and make count 0
                        f=open('check.txt','a')
                        f.write(output)
                        f.close()
                        count = 0
        ...
        #print far      
        #print equi_diameter
                print ('Radius:'+str(PI*radius*radius) +"Area:"+ str(area))
                print (str(area_of_circle - area))
                print ("The solidity is:" + str(solidity))
                print ("The aspect ratio is :"+ str(aspect_ratio))
                print ("The number of convexity defects are :"+ str(count_defects))
                print ("The extent is :"+ str(extent))
                print ("the angle is:"+ str(angle_t))
                print ('\033[91m'+"The area of effective circle is " +'\033[0m'+ str(area_of_circle - area))
